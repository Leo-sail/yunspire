...
我当前只为仓库默认分支上的最新版本提供安全修复。当前版本为 `0.4.1`。
...
I currently provide security fixes only for the latest version on the repository's default branch. The current version is `0.4.1`.
