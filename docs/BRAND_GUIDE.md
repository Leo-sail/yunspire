...
我设计云枢不是为了替代用户思考，也不是为了制造另一个封闭云端空间。我希望它把本地知识、用户选择的模型、第一方能力和自动化任务连接起来，让信息经过理解、行动、验证和复盘后重新成为用户可以长期拥有的知识。

### 2. 品牌承诺

1. **知识属于用户**：Obsidian Vault 保持可阅读、可迁移、可备份。
2. **智能必须落地**：AI助手不仅回答，还要在受控边界内完成真实操作。
3. **内容成为知识**：采集内容经过来源保留、模型分析、质量门禁和结构整理。
4. **系统持续成长**：报告与优化帮助用户复盘，但重要变化必须可审阅、可回滚。
5. **结果可信可查**：任务、文件变化和失败原因都有真实状态与操作记录。

### 3. 目标用户

- 长期使用 Obsidian、重视知识所有权的个人用户。
- 处理大量网页、文档、图片、音视频和研究资料的知识工作者。
- 希望用自然语言统一调用模型、Skill 和本地任务的创作者与研究者。
- 重视隐私、可控性、来源和长期复盘的专业人士。
...
- 用具体结果代替夸张承诺。
- 用“本地”“可验证”“可恢复”等事实表达价值。
- 不使用“全能”“颠覆”“无限”等无法验证的营销词。
- 不把规划能力写成当前已经实现的能力。
- 中文为主要沟通语言，英文用于国际识别和技术文档。
- 第一方文档使用我的作者视角；不使用第三方代写或生成式署名。
...
品牌资源位于 `desktop-ui/assets/brand/`：

- `yunspire-app-icon.png`：应用图标源图。
- `yunspire-symbol.png`：独立符号。
- `yunspire-wordmark.jpg`：字标。
- `yunspire-lockup.jpg`：符号与字标组合。
- `yunspire-favicon.png`：小尺寸图标。
- `yunspire-logo-original.jpg`：原始品牌图。
...
Yunspire、云枢、Logo、第一方界面和品牌资产均属于本项目的权利范围。未经我的书面商业授权，不得将这些资产用于商业产品、收费服务或使他人误认为存在官方合作。第三方软件和 Obsidian 品牌仍属于各自权利人。
...
1. **User-owned knowledge**: Obsidian Vaults remain readable, portable, and backup-friendly.
2. **Intelligence that acts**: the Assistant completes real operations within controlled boundaries.
3. **Information becomes knowledge**: capture preserves provenance, uses model analysis, applies quality gates, and creates structure.
4. **Sustainable improvement**: reports and proposals support reflection while important changes remain reviewable and reversible.
5. **Verifiable outcomes**: tasks, file changes, and failures have real state and operation records.

### 3. Audience and voice

Yunspire serves Obsidian users, knowledge workers, creators, researchers, and professionals who value ownership, privacy, provenance, control, and long-term reflection.

The voice is calm, clear, restrained, and factual. I use concrete outcomes rather than superlatives, describe planned work as planned, communicate primarily in Chinese with English technical support, and write first-party project documents from my own perspective without third-party authorship claims.
...
Yunspire, 云枢, the Logo, first-party interface, and brand assets are protected project assets. They may not be used in a commercial product or paid service, or to imply official authorization, without my prior written commercial license. Third-party software and the Obsidian brand remain the property of their respective owners.
